                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" style="width: 100; height: 120px;" src="{{pare_url_file($product->options->avatar)}}" />
                                </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12"><input type="phone" name="phone" class="form-control" value="{{get_data_user('web','phone')}}" /></div>
                            </div>
                            <div class="form-group">

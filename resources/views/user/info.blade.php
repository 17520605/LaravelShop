    ...
    <div class="col-sm-12">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="phone" class="form-control" placeholder="Số điện thoại" name="phone" value="{{$user->phone}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <textarea name="about"  class="form-control" cols="30" rows="5" placeholder="Giới thiệu bản thân">{{$user->about}}</textarea>
            </div>

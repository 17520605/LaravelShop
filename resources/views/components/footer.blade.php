                    ...
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <ul>
                                ...
                                <li><a href="{{ route('get.delivery')}}">Thông tin giao hàng</a></li>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Our Address</h3>
                            <p>Linh Trung ,Thu Duc ,HCM City </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Email Support</h3>
                            <p>Nguyenhuuminhkhai@gmail.com</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <address>Copyright © <a href="">Khainguyenhuuminh.</a> All Rights Reserved</address>
                </div>
                <div class="col-md-6 col-xs-12">

...
<div class="slider-area an-1 hm-1">
    ...
    <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides">	
            <img src="{{ asset ('img/slide/1.png' )}}" alt="" title="#slider-direction-1"  />
            <img src="{{ asset ('img/slide/2.png' )}}" alt="" title="#slider-direction-2"  />
            <img src="{{ asset ('img/slide/3.png' )}}" alt="" title="#slider-direction-3"  />
        </div>
        {{--  <!-- direction 1 -->

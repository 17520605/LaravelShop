                    ...
                    <form method="post" class="login" action="" >
                        ...
                        <div class="form-fields">
                            ...
                            <p class="form-row form-row-wide">
                                <label for="username">Email đăng nhập<span class="required">*</span></label>
                        ...
                        <div class="form-action">
                            <p class="lost_password"> <a href="{{ route('get.form.reset.password') }} "target="_blank">Quên mật khẩu?</a></p>

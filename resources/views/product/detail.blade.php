                ...
                <div class="tab-content">
                    ...
                    <div class="compoment_rating" style="margin-bottom: 20px">
                        ...
                        <div class="compoment_rating_content" style="display:flex;align-items: center; border: 1px solid #dedede;border-radius: 5px;">
                                ...
                                @foreach ($arrayRatings as $key => $arrayRating)
                                    ...
                                    <div class="item_rating" style="display:flex ;align-items: center">
                                        <div style="width: 10%; font-size: 14px">
                                            {{$key}}<span style="margin-left: 5px" class=" fa fa-star"></span>
                                        </div>
                                        <div style="width: 70%; margin:0 20px">
                                            <span style="with:100%; height: 8px;display: block;border: 1px solid #dedede ; border-radius:5px; " >
                                                <b style="width: {{$itemAge}}%; background-color: #ff9705; display: block; border-radius: 5px;height: 100%; "></b>
                                            </span>
                                        </div>
                                        <div style="width: 20%;">
                            ...
                            <div>
                                <a class="js_rating_action" style=" width: 200px;background: #288ad6;padding: 10px;color: white;border-radius:5px ">Gửi đánh giá của bạn</a>
                            </div>
                        </div>
                        <?php 
                            $listRatingText = [
